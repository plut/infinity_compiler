...
pub trait ResourceTree: SqlRow {
	...
	fn read_rows<'a,'b,'c>(tree: &'c mut Tree<Self::StatementForest<'c>>, params: impl rusqlite::Params)
// 	->Result<&'c mut Self::StatementForest<'c>>
// 	->Result<TypedRows<'c,(Self::Primary,Self)>>
	->Result<RecursiveRows<'c,'c,'c,Self>>
	{
...
impl<'a,'b,'c, T: ResourceTree> Iterator for RecursiveRows<'a,'b,'c,T> {
