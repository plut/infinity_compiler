...
pub trait ResourceTree: SqlRow {
	...
	fn select_subresources<'a,'b:'c,'c>(&'a mut self, branches: &'b mut Self::StatementForest<'c>,
...
// 	}
	fn collect_all<'a:'b,'b>(tree: &'a mut Tree<Self::StatementForest<'b>>, params: impl rusqlite::Params)->Result<Vec<Self>> where Self: 'b{
...
impl<'a,'b:'c,'c, T: ResourceTree> RecursiveRows<'a,'b,'c,T> {
